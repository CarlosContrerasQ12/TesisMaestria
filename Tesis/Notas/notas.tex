...
\begin{document}
	...
	\section*{Calendario}
	\begin{enumerate}
		\item Lunes 1 Mayo: Escribir DGM e interpolation. Programar DGM
		\item Martes 2 Mayo: Programar interpolation sin sillas
		\item Miercoles 3 Mayo: Escribir Games
		\item Jueves 4 Mayo: Programar Games con sillas
		\item Viernes 5 Mayo:Programar Games con sillas
		\item Sabado 6 Mayo:Escribir HJB libre resultados
		\item Domingo 7 Mayo: Esciribir HJB boudary resultados
		\item Lunes 8 Mayo: Escribir Games sillas deep fictious
		\item Martes 9 Mayo: Escribir Neural Networks
		\item Miercoles 10 Mayo: Escribir Neural networks
		\item Jueves 11 Mayo: Escribir mean field
		\item Viernes 12 Mayo: Programar mean field
		\item Sabado 13 Mayo: Escibir intro y conclusión
		\item Domingo 14 Mayo: Revisar documento(Enviar a MAuricio)
		\item Lunes 15 Mayo: Programar Mean field
		\item Martes 16 Mayo:Programar Mean field
		\item Miercoles 17 Mayo: Escribir apendice reflected SDE
		\item Jueves 18 Mayo: Escribir apendice reflected SDE
		\item Viernes 19 Mayo:
		\item Sabado 20 Mayo:
		\item Domingo 21 Mayo:
		\item Lunes 22 Mayo: 
		\item Martes 23 Mayo:
